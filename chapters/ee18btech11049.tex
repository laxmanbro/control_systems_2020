...
\begin{figure}[!h]
\centering
  \includegraphics[width=\columnwidth]{./figs/ee18btech11049_2.eps}
  \caption{b}
  \label{fig:ee18btech11049_phase}
\end{figure}
The following code plots Fig  \ref{fig:ee18btech11049_gain}:a and \ref{fig:ee18btech11049_phase}:b 
...
\end{align}{}
Solving \eqref{eq:ee18btech11049_gain} \brak{or}\\ from Fig \ref{fig:ee18btech11049_gain}:a frequency at which gain = 1 ,is gain crossover frequency $\omega_{gc}$ .
...
\\
\solution From Fig \ref{fig:ee18btech11049_phase}:b ,we can say that phase  never crosses $-180\degree$ .
